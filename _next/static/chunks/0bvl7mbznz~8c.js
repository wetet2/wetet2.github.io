...
`,l=i.default.div.withConfig({displayName:"styled__Panel",componentId:"sc-859c6c55-2"})`
  display: flex;
  ...
  overflow-y: auto;
  z-index: 10;
`,u=(0,i.default)(l).withConfig({displayName:"styled__LeftPanel",componentId:"sc-859c6c55-3"})`
  /* left: 20px; */
`;(0,i.default)(l).withConfig({displayName:"styled__RightPanel",componentId:"sc-859c6c55-4"})`
  right: 20px;
`;let s=i.default.hr.withConfig({displayName:"styled__Divider",componentId:"sc-859c6c55-5"})`
  border: none;
  border-top: 1px solid #3f3f46;
  margin: 0;
`,c=i.default.h2.withConfig({displayName:"styled__SectionTitle",componentId:"sc-859c6c55-6"})`
  margin: 0 0 8px 0;
  font-size: 14px;
  font-weight: 600;
  color: #eeeeee;
`,d=i.default.div.withConfig({displayName:"styled__ButtonGroup",componentId:"sc-859c6c55-7"})`
  display: flex;
  flex-wrap: ${e=>e.$nowrap?"nowrap":"wrap"};
  gap: 8px;
`,f=i.default.button.withConfig({displayName:"styled__Button",componentId:"sc-859c6c55-8"})`
...
`,p=i.default.div.withConfig({displayName:"styled__ColorInputWrap",componentId:"sc-859c6c55-9"})`
  position: relative;
  width: 32px; /* 원하는 크기 */
  height: 32px;
  border-radius: 50%; /* 원형으로 설정 */
  overflow: hidden;
`,h=i.default.input.withConfig({displayName:"styled__ColorInput",componentId:"sc-859c6c55-10"})`
  /* width: 100%;
  height: 36px;
  min-height: 36px;
  border: none;
  ...
  cursor: pointer;
  background: none;
`,m=i.default.input.withConfig({displayName:"styled__NumberInput",componentId:"sc-859c6c55-11"})`
  width: 100%;
  padding: 8px 10px;
...
`,y=i.default.input.withConfig({displayName:"styled__TextInput",componentId:"sc-859c6c55-12"})`
  width: 100%;
  padding: 8px 10px;
  border: 1px solid #52525b;
  border-radius: 8px;
...
`,g=i.default.div.withConfig({displayName:"styled__InputRow",componentId:"sc-859c6c55-13"})`
  display: flex;
  gap: 8px;
  align-items: flex-end;
`;i.default.div.withConfig({displayName:"styled__DimField",componentId:"sc-859c6c55-14"})`
  display: flex;
  flex-direction: column;
  gap: 3px;
  flex: 1;
`,i.default.span.withConfig({displayName:"styled__DimLabel",componentId:"sc-859c6c55-15"})`
  font-size: 10px;
  font-weight: 700;
  color: #71717a;
  ...
  padding-left: 2px;
`;let b=i.default.div.withConfig({displayName:"styled__DimInputWrapper",componentId:"sc-859c6c55-16"})`
  position: relative;
  flex: 0 0 auto;
...
`,_=i.default.span.withConfig({displayName:"styled__DimInlineLabel",componentId:"sc-859c6c55-17"})`
  position: absolute;
  right: 8px;
  top: 50%;
  ...
  pointer-events: none;
  user-select: none;
`,x=i.default.div.withConfig({displayName:"styled__Hint",componentId:"sc-859c6c55-18"})`
  font-size: 12px;
  color: #a1a1aa;
  line-height: 1.5;
`,v=i.default.div.withConfig({displayName:"styled__List",componentId:"sc-859c6c55-19"})`
  display: flex;
  flex-direction: column;
  gap: 6px;
  margin-bottom: 8px;
`,w=i.default.div.withConfig({displayName:"styled__ListItem",componentId:"sc-859c6c55-20"})`
  position: relative;
  display: flex;
  align-items: center;
  justify-content: space-between;
  ...
  `}
`,k=i.default.div.withConfig({displayName:"styled__RoomChildren",componentId:"sc-859c6c55-21"})`
  display: flex;
  flex-direction: column;
  gap: 4px;
  margin-left: 14px;
...
`,C=i.default.span.withConfig({displayName:"styled__ListItemType",componentId:"sc-859c6c55-22"})`
  font-size: 11px;
  color: #d4d4d8;
`,j=i.default.div.withConfig({displayName:"styled__HeaderButtons",componentId:"sc-859c6c55-23"})`
  display: flex;
  gap: 8px;
  align-items: center;
`,E=i.default.input.withConfig({displayName:"styled__OpacitySlider",componentId:"sc-859c6c55-24"})`
  width: 100%;
  cursor: pointer;
`,S=i.default.div.withConfig({displayName:"styled__Toolbar",componentId:"sc-859c6c55-25"})`
  position: absolute;
  top: 50px;
  left: 240px;
  right: 0px;
  ...
  color: #ffffff;
  flex-wrap: wrap;
`;i.default.div.withConfig({displayName:"styled__ToolbarDivider",componentId:"sc-859c6c55-26"})`
  width: 1px;
  height: 22px;
  background: #3f3f46;
  flex-shrink: 0;
`;var O=e.i(59858),T=e.i(85103);let I=(0,r.default)(()=>e.A(17050),{loadableGenerated:{modules:[97220]},ssr:!1}),P=["bed","chair","table","sofa","bookshelf","shelf","washingMachine","refrigerator"],$={bed:"#8b5cf6",chair:"#f59e0b",table:"#10b981",sofa:"#3b82f6",bookshelf:"#ec4899",shelf:"#14b8a6",washingMachine:"#94a3b8",refrigerator:"#64748b",door:"#92400e"},N={position:[16e3,16e3,16e3],target:[0,0,0]},R="dtf-state",L={id:`room-${Date.now()}`,kind:"room",name:"방 1",width:8e3,depth:8e3,height:3e3,position:[0,0,0],rotation:[0,0,0],color:"#a8afb3"};e.s(["default",0,function(){let[e,r]=(0,n.useState)([L]),[i,l]=(0,n.useState)(null),[D,A]=(0,n.useState)("translate"),[M,H]=(0,n.useState)(N),[U,F]=(0,n.useState)(1),[z,B]=(0,n.useState)(!1),[X,Y]=(0,n.useState)(null),[V,Z]=(0,n.useState)(!1),[W,G]=(0,n.useState)(!1),K=(0,n.useRef)(L.id),q=(0,n.useRef)(null),J=(0,n.useRef)(e),Q=(0,n.useRef)([]),ee=(0,n.useRef)([]),et=(0,n.useRef)(null),en=(0,n.useCallback)(()=>{Z(Q.current.length>0),G(ee.current.length>0)},[]),er=(0,n.useCallback)(e=>{l(e),null===e&&A("translate")},[]),ei=(0,n.useCallback)(e=>{Q.current.push(J.current),ee.current=[],r(e),en()},[en]),eo=(0,n.useCallback)(()=>{if(0===Q.current.length)return;let e=J.current,t=Q.current.pop();ee.current.push(e),r(t),en()},[en]),ea=(0,n.useCallback)(()=>{if(0===ee.current.length)return;let e=J.current,t=ee.current.pop();Q.current.push(e),r(t),en()},[en]),el=(0,n.useCallback)(()=>{let e=`room-${Date.now()}`,t=J.current.filter(e=>"room"===e.kind),n=(0,O.findNonOverlappingRoomPosition)(t,8e3,8e3),r=J.current.filter(e=>"room"===e.kind).length,i={id:e,kind:"room",name:`방 ${r+1}`,width:8e3,depth:8e3,height:3e3,position:n,rotation:[0,0,0],color:"#a8afb3"};ei([...J.current,i]),er(e)},[ei,er]),eu=(0,n.useCallback)(e=>{let t=`${e}-${Date.now()}`,n=J.current.find(e=>e.id===i)??null,r=(()=>{if(n?.kind==="room")return n;if(K.current){let e=J.current.find(e=>"room"===e.kind&&e.id===K.current);if(e)return e}return J.current.find(e=>"room"===e.kind)})(),o=T.FURNITURE_DEFAULT_DIMENSIONS[e],a=J.current.filter(e=>"furniture"===e.kind).length,l={id:t,kind:"furniture",furnitureType:e,roomId:r?.id??null,name:`${T.TYPE_LABELS[e]} ${a+1}`,width:o.width,depth:o.depth,height:o.height,position:[0,10*("door"!==e),0],rotation:[0,0,0],color:$[e]};ei([...J.current,l]),er(t)},[ei,i,er]),es=(0,n.useCallback)((e,t)=>{ei(J.current.map(n=>n.id===e?{...n,...t}:n))},[ei]),ec=(0,n.useCallback)(()=>{if(!i)return;let e=J.current.find(e=>e.id===i);e?.kind==="room"?ei(J.current.filter(e=>("furniture"!==e.kind||e.roomId!==i)&&e.id!==i)):ei(J.current.filter(e=>e.id!==i)),er(null)},[ei,i,er]),ed=(0,n.useCallback)(e=>e.map(e=>{if("furniture"!==e.kind)return e;let t=T.FURNITURE_DEFAULT_DIMENSIONS[e.furnitureType];return t&&("number"!=typeof e.width||"number"!=typeof e.depth||"number"!=typeof e.height)?Array.isArray(e.scale)&&3===e.scale.length?{...e,width:t.width*e.scale[0],depth:t.depth*e.scale[2],height:t.height*e.scale[1]}:{...e,width:t.width,depth:t.depth,height:t.height}:e}),[]),ef=(0,n.useCallback)(e=>{let t=e.filter(e=>"room"===e.kind),n=e.filter(e=>"furniture"===e.kind);return t.length<=1&&0===n.length},[]),ep=(0,n.useCallback)(()=>{let t=new Blob([JSON.stringify({items:e,camera:M,wallOpacity:U,version:1},null,2)],{type:"application/json"}),n=URL.createObjectURL(t),r=document.createElement("a");r.href=n,r.download=`drop-the-furniture-${Date.now()}.json`,r.click(),URL.revokeObjectURL(n)},[e,M,U]),eh=(0,n.useCallback)(e=>{let t=e.target.files?.[0];if(!t)return;let n=new FileReader;n.onload=e=>{try{let t=JSON.parse(e.target?.result);if(!Array.isArray(t.items)||!t.camera)return void window.alert("올바르지 않은 파일 형식입니다.");let n=ed(t.items);ei(n),H(t.camera),F(t.wallOpacity??1),er(null)}catch{window.alert("JSON 파싱에 실패했습니다.")}},n.readAsText(t),e.target.value=""},[ei,er,ed]),em=(0,n.useCallback)(()=>{(Q.current?.length>0||ee.current?.length>0)&&ep();let e={id:`room-${Date.now()}`,kind:"room",name:"방 1",width:8e3,depth:8e3,height:3e3,position:[0,0,0],rotation:[0,0,0],color:"#a8afb3"};Q.current=[],ee.current=[],r([e]),er(null),H(N),F(.5),K.current=e.id,localStorage.removeItem(R),en()},[en,ep,er]);(0,n.useEffect)(()=>{let e=e=>{let t=e.items.find(e=>"room"===e.kind);K.current=t?.id??L.id,(0,n.startTransition)(()=>{r(e.items),l(e.selectedId??null),A(e.mode??"translate"),H(e.camera??N),F(e.wallOpacity??1),B(e.autoTransparent??!1)})},t=function(){try{let e=localStorage.getItem(R);if(e)return JSON.parse(e)}catch{}return null}();t&&Array.isArray(t.items)&&!ef(t.items)?e({items:ed(t.items),camera:t.camera,wallOpacity:t.wallOpacity,autoTransparent:t.autoTransparent,selectedId:t.selectedId,mode:t.mode}):fetch("/sample_layout.json").then(e=>e.json()).then(t=>{Array.isArray(t.items)&&e({items:ed(t.items),camera:t.camera,wallOpacity:t.wallOpacity})}).catch(()=>{})},[ef,ed]),(0,n.useEffect)(()=>{J.current=e},[e]),(0,n.useEffect)(()=>{localStorage.setItem(R,JSON.stringify({items:e,selectedId:i,mode:D,camera:M,wallOpacity:U,autoTransparent:z,version:1}))},[e,i,D,M,U,z]),(0,n.useEffect)(()=>{let t=e.find(e=>e.id===i);t?.kind==="room"&&(K.current=t.id)},[e,i]),(0,n.useEffect)(()=>{let e=e=>{if("Delete"===e.key||"Backspace"===e.key){if(e.target instanceof HTMLInputElement||e.target instanceof HTMLTextAreaElement)return;if(i){e.preventDefault(),ec();return}}(e.ctrlKey||e.metaKey)&&("z"!==e.key.toLowerCase()||e.shiftKey?("y"===e.key.toLowerCase()||"z"===e.key.toLowerCase()&&e.shiftKey)&&(e.preventDefault(),ea()):(e.preventDefault(),eo()))};return window.addEventListener("keydown",e),()=>{window.removeEventListener("keydown",e)}},[eo,ea,i,ec]),e.filter(e=>"room"===e.kind).length,e.filter(e=>"furniture"===e.kind).length;let ey=e.filter(e=>"room"===e.kind),eg=e.filter(e=>"furniture"===e.kind&&!e.roomId),eb=e.find(e=>e.id===i);return eb?.kind,(0,t.jsxs)(o,{children:[(0,t.jsxs)(a,{children:[(0,t.jsxs)("div",{children:[(0,t.jsx)("h1",{children:"Drop the Furniture"}),(0,t.jsx)("p",{children:"방과 가구를 자유롭게 배치핼보세요."})]}),(0,t.jsxs)(j,{children:[(0,t.jsx)(f,{$compact:!0,onClick:em,children:"🗑️ New"}),(0,t.jsx)(f,{$compact:!0,onClick:eo,disabled:!V,children:"↩ Undo"}),(0,t.jsx)(f,{$compact:!0,onClick:ea,disabled:!W,children:"↪ Redo"}),(0,t.jsx)(f,{$compact:!0,onClick:ep,children:"💾 저장"}),(0,t.jsx)(f,{$compact:!0,onClick:()=>et.current?.click(),children:"📂 불러오기"}),(0,t.jsx)("input",{ref:et,type:"file",accept:"application/json",style:{display:"none"},onChange:eh})]})]}),(0,t.jsxs)(u,{children:[(0,t.jsx)(c,{children:"방 추가"}),(0,t.jsxs)(d,{children:[(0,t.jsx)(f,{onClick:el,children:"방 추가"}),(0,t.jsx)(f,{onClick:()=>eu("door"),children:"🚪 문"})]}),(0,t.jsx)(s,{}),(0,t.jsx)(c,{children:"가구 추가"}),(0,t.jsx)(d,{children:P.map(e=>(0,t.jsx)(f,{onClick:()=>eu(e),children:T.TYPE_LABELS[e]},e))}),(0,t.jsx)(x,{children:"버튼을 누르면 방 중앙에 방/가구/문이 생성됩니다."}),(0,t.jsx)(s,{}),(0,t.jsx)(c,{children:"설정"}),(0,t.jsx)(x,{children:"벽 투명도"}),(0,t.jsx)(E,{type:"range",min:0,max:1,step:.05,value:U,onChange:e=>F(parseFloat(e.target.value))}),(0,t.jsx)(f,{$compact:!0,$active:z,onClick:()=>B(e=>!e),children:"👁 자동 투명"}),(0,t.jsx)(s,{}),(0,t.jsx)(c,{children:"목록"}),(0,t.jsxs)(v,{children:[ey.map(r=>{let o=e.filter(e=>"furniture"===e.kind&&e.roomId===r.id);return(0,t.jsxs)(n.Fragment,{children:[(0,t.jsxs)(w,{$selected:r.id===i,$kind:"room",$dragOver:X===r.id,onClick:()=>er(r.id),onDragOver:e=>{e.preventDefault(),q.current&&Y(r.id)},onDragLeave:()=>Y(null),onDrop:()=>{let e=q.current;e&&(es(e,{roomId:r.id,position:[0,10,0]}),q.current=null,Y(null))},children:[(0,t.jsx)("span",{children:r.name}),(0,t.jsx)(C,{children:"방"})]}),o.length>0&&(0,t.jsx)(k,{children:o.map(e=>(0,t.jsxs)(w,{$selected:e.id===i,$kind:"furniture",$tree:!0,draggable:!0,onClick:()=>er(e.id),onDragStart:()=>{q.current=e.id},onDragEnd:()=>{q.current=null,Y(null)},children:[(0,t.jsx)("span",{children:e.name}),(0,t.jsx)(C,{children:T.TYPE_LABELS[e.furnitureType]})]},e.id))})]},r.id)}),eg.map(e=>(0,t.jsxs)(w,{$selected:e.id===i,$kind:"furniture",draggable:!0,onClick:()=>er(e.id),onDragStart:()=>{q.current=e.id},onDragEnd:()=>{q.current=null,Y(null)},children:[(0,t.jsx)("span",{children:e.name}),(0,t.jsx)(C,{children:T.TYPE_LABELS[e.furnitureType]})]},e.id))]}),!eb&&(0,t.jsx)(x,{children:"목록에서 항목을 클릭하면 선택해서 편집할 수 있습니다."})]}),eb&&(0,t.jsxs)(S,{children:[(0,t.jsx)(d,{$nowrap:!0,children:["translate","rotate","scale"].map(e=>(0,t.jsx)(f,{$active:D===e,onClick:()=>A(e),children:T.MODE_LABELS[e]},e))}),(0,t.jsx)(y,{type:"text",value:eb.name,style:{width:"130px"},onChange:e=>es(eb.id,{name:e.target.value})}),(0,t.jsx)(p,{children:(0,t.jsx)(h,{type:"color",value:eb.color,style:{width:"36px",padding:0},onChange:e=>es(eb.id,{color:e.target.value})})}),("room"===eb.kind||"furniture"===eb.kind)&&(0,t.jsx)(g,{style:{gap:"6px"},children:["width","depth","height"].map((e,n)=>(0,t.jsxs)(b,{style:{width:"72px"},children:[(0,t.jsx)(m,{type:"number",min:100,step:"room"===eb.kind?100:10,value:eb[e],onChange:t=>es(eb.id,{[e]:parseFloat(t.target.value)||1})}),(0,t.jsx)(_,{children:["W","D","H"][n]})]},e))}),(0,t.jsx)(f,{$danger:!0,$compact:!0,onClick:ec,children:"삭제"})]}),(0,t.jsx)(I,{items:e,selectedId:i,mode:D,cameraState:M,wallOpacity:U,autoTransparent:z,onSelect:er,onChange:es,onCameraChange:H})]})}],83594)},9977,(e,t,n)=>{(window.__NEXT_P=window.__NEXT_P||[]).push(["/c",()=>e.r(83594)]),t.hot&&t.hot.dispose(function(){window.__NEXT_P.push(["/c"])})},48761,e=>{e.v(t=>Promise.all(["static/chunks/0ikevdng~je0t.js"].map(t=>e.l(t))).then(()=>t(93594)))},28805,e=>{e.v(t=>Promise.all(["static/chunks/0599p99vu8fk5.js"].map(t=>e.l(t))).then(()=>t(79466)))},17050,e=>{e.v(t=>Promise.all(["static/chunks/0_5j0awwlp83t.js"].map(t=>e.l(t))).then(()=>t(97220)))}]);