...
`;let s=r.default.div.withConfig({displayName:"styled__ToolbarBrand",componentId:"sc-7094a356-1"})`
  font-size: 14px;
  font-weight: 700;
  letter-spacing: 2px;
...
`,u=r.default.div.withConfig({displayName:"styled__Container",componentId:"sc-7094a356-2"})`
  display: flex;
  align-items: center;
  ...
  background: #0a0a0f;
  overflow: hidden;
`,l=r.default.div.withConfig({displayName:"styled__Grid",componentId:"sc-7094a356-3"})`
  position: absolute;
  inset: 0;
  background-image:
  ...
  pointer-events: none;
`,c=r.default.div.withConfig({displayName:"styled__Scanline",componentId:"sc-7094a356-4"})`
  position: absolute;
  inset: 0;
...
`,y=r.default.p.withConfig({displayName:"styled__Subtitle",componentId:"sc-7094a356-9"})`
  margin: -24px 0 0;
  font-size: 14px;
  color: rgba(255, 255, 255, 0.3);
  text-align: center;
  letter-spacing: 0.5px;
`,g=r.default.div.withConfig({displayName:"styled__CardGrid",componentId:"sc-7094a356-10"})`
  display: flex;
  flex-direction: column;
  gap: 12px;
  width: 100%;
...
`,h=(0,r.default)(o.default).withConfig({displayName:"styled__Card",componentId:"sc-7094a356-11"})`
  display: flex;
  align-items: center;
  gap: 16px;
  padding: 18px 22px;
...
`,_=r.default.div.withConfig({displayName:"styled__CardText",componentId:"sc-7094a356-13"})`
  ...
  flex: 1;
  min-width: 0;
`,b=r.default.div.withConfig({displayName:"styled__CardTitle",componentId:"sc-7094a356-14"})`
  font-size: 15px;
  font-weight: 600;
  color: #fff;
`,v=r.default.div.withConfig({displayName:"styled__CardDesc",componentId:"sc-7094a356-15"})`
  font-size: 12px;
  color: rgba(255, 255, 255, 0.35);
  white-space: nowrap;
  text-overflow: ellipsis;
  overflow: hidden;
`,x=r.default.span.withConfig({displayName:"styled__Arrow",componentId:"sc-7094a356-16"})`
  flex-shrink: 0;
  font-size: 18px;
...
`,w=r.default.div.withConfig({displayName:"styled__Footer",componentId:"sc-7094a356-17"})`
  ...
  letter-spacing: 2px;
  text-transform: uppercase;
`,k=[{href:"/t",short:"Typing",icon:"⌨️",title:"손은 눈보다 빠르다",desc:"타이핑으로 실력을 연습하자"},{href:"/c",short:"Furniture",icon:"🪑",title:"Drop The Furniture",desc:"3D 공간에 가구 배치하기"},{href:"/d",short:"Drawing",icon:"✏️",title:"Drawing Board",desc:"자유롭게 그리고 색칠하기"},{href:"/g",short:"Chat",icon:"💬",title:"AI Chat",desc:"AI와 자유로운 대화"},{href:"/n",short:"News",icon:"📰",title:"AI 뉴스",desc:"최신 AI 뉴스 다이제스트"}];e.s(["default",0,function(){return(0,t.jsxs)(u,{children:[(0,t.jsxs)(n.default,{children:[(0,t.jsx)("title",{children:"Everything AI Have"}),(0,t.jsx)("meta",{name:"description",content:"Everything AI Have — 여러 AI 도구를 한곳에 모은 프로젝트입니다."})]}),(0,t.jsx)(l,{}),(0,t.jsx)(c,{}),(0,t.jsx)(f,{$top:"10%",$left:"5%",$size:"400px",$delay:0}),(0,t.jsx)(f,{$top:"60%",$left:"70%",$size:"350px",$delay:2.5}),(0,t.jsxs)(d,{children:[(0,t.jsxs)(s,{children:["everything ",(0,t.jsx)("span",{children:"ai"})," have"]}),(0,t.jsxs)(p,{children:["나의 ",(0,t.jsx)("span",{children:"AI"}),"저씨"]}),(0,t.jsx)(y,{children:"AI 주인님께 드리는 미천한 나의 프롬프트"}),(0,t.jsx)(g,{children:k.map(e=>(0,t.jsxs)(h,{href:e.href,children:[(0,t.jsx)(m,{children:e.icon}),(0,t.jsxs)(_,{children:[(0,t.jsx)(b,{children:e.title}),(0,t.jsx)(v,{children:e.desc})]}),(0,t.jsx)(x,{className:"arrow",children:"→"})]},e.href))}),(0,t.jsx)(w,{children:"©https://github.com/wetet2"})]})]})}],87856)},55075,(e,t,n)=>{(window.__NEXT_P=window.__NEXT_P||[]).push(["/",()=>e.r(87856)]),t.hot&&t.hot.dispose(function(){window.__NEXT_P.push(["/"])})},48761,e=>{e.v(t=>Promise.all(["static/chunks/0ey~yy8oeyp~5.js"].map(t=>e.l(t))).then(()=>t(93594)))},28805,e=>{e.v(t=>Promise.all(["static/chunks/0599p99vu8fk5.js"].map(t=>e.l(t))).then(()=>t(79466)))}]);