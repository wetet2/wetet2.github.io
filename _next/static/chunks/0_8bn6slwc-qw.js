...
`,S=a.default.span.withConfig({displayName:"styled__DimInlineLabel",componentId:"sc-859c6c55-21"})`
  position: absolute;
  right: 8px;
  top: 50%;
  ...
  pointer-events: none;
  user-select: none;
`,C=a.default.div.withConfig({displayName:"styled__Hint",componentId:"sc-859c6c55-22"})`
  font-size: 12px;
  color: #a1a1aa;
  line-height: 1.5;
`,E=a.default.div.withConfig({displayName:"styled__List",componentId:"sc-859c6c55-23"})`
  display: flex;
  flex-direction: column;
  gap: 6px;
  margin-bottom: 8px;
`,O=a.default.div.withConfig({displayName:"styled__ListItem",componentId:"sc-859c6c55-24"})`
  position: relative;
  display: flex;
  align-items: center;
  justify-content: space-between;
  ...
  `}
`,T=a.default.div.withConfig({displayName:"styled__RoomChildren",componentId:"sc-859c6c55-25"})`
  display: flex;
  flex-direction: column;
  gap: 4px;
  margin-left: 14px;
  ...
  ${e=>e.$empty&&`
    ...
    justify-content: center;
  `}
`,I=a.default.span.withConfig({displayName:"styled__ListItemType",componentId:"sc-859c6c55-26"})`
  font-size: 11px;
  color: #d4d4d8;
...
`;a.default.div.withConfig({displayName:"styled__ToolbarDivider",componentId:"sc-859c6c55-32"})`
  ...
  background: #3f3f46;
  flex-shrink: 0;
`;var A=e.i(59858),R=e.i(85103);let M=(0,r.default)(()=>e.A(17050),{loadableGenerated:{modules:[97220]},ssr:!1}),H=["bed","chair","table","sofa","bookshelf","shelf","washingMachine","refrigerator"],U=["fountain","donkey","couch","badDouble","bookcase2","chair2","door2"],F={bed:"#8b5cf6",chair:"#f59e0b",table:"#10b981",sofa:"#3b82f6",bookshelf:"#ec4899",shelf:"#14b8a6",washingMachine:"#94a3b8",refrigerator:"#64748b",door:"#92400e"},z={fountain:"#06b6d4",donkey:"#a78bfa",couch:"#f59e0b",badDouble:"#ef4444",bookcase2:"#ec4899",chair2:"#f59e0b",door2:"#92400e"},B={position:[16e3,16e3,16e3],target:[0,0,0]},W="dtf-state",X={container:e=>({...e,width:"150px"}),control:e=>({...e,background:"#27272a",borderColor:"#52525b",borderRadius:"8px",minHeight:"34px",boxShadow:"none",cursor:"pointer",fontSize:"13px",":hover":{borderColor:"#71717a"}}),singleValue:e=>({...e,color:"#ffffff"}),input:e=>({...e,color:"#ffffff"}),menu:e=>({...e,background:"#27272a",border:"1px solid #52525b",borderRadius:"8px",overflow:"hidden",zIndex:30}),option:(e,t)=>({...e,background:t.isSelected?"#3b82f6":t.isFocused?"#3f3f46":"#27272a",color:"#ffffff",cursor:"pointer",fontSize:"13px"}),indicatorSeparator:e=>({...e,background:"#52525b"}),dropdownIndicator:e=>({...e,color:"#a1a1aa"})},G={id:`room-${Date.now()}`,kind:"room",name:"방 1",width:8e3,depth:8e3,height:3e3,position:[0,0,0],rotation:[0,0,0],color:"#a8afb3"};e.s(["default",0,function(){let[e,r]=(0,n.useState)([G]),[a,d]=(0,n.useState)(null),[Y,V]=(0,n.useState)("translate"),[Z,K]=(0,n.useState)(B),[J,q]=(0,n.useState)(1),[Q,ee]=(0,n.useState)(!1),[et,en]=(0,n.useState)(null),[er,eo]=(0,n.useState)(!1),[ei,ea]=(0,n.useState)(!1),[el,es]=(0,n.useState)(!1),[eu,ec]=(0,n.useState)(!1),[ed,ef]=(0,n.useState)(()=>new Set),ep=(0,n.useRef)(null),eh=(0,n.useRef)(G.id),em=(0,n.useRef)(null),ey=(0,n.useRef)(e),eg=(0,n.useRef)([]),eb=(0,n.useRef)([]),ex=(0,n.useRef)(null),e_=(0,n.useCallback)(()=>{eo(eg.current.length>0),ea(eb.current.length>0)},[]),ew=(0,n.useCallback)(e=>{d(e),null===e&&V("translate")},[]),ev=(0,n.useCallback)(e=>{ef(t=>{let n=new Set(t);return n.has(e)?n.delete(e):n.add(e),n})},[]),ek=(0,n.useCallback)(e=>{eg.current.push(ey.current),eb.current=[],r(e),e_()},[e_]),ej=(0,n.useCallback)(()=>{if(0===eg.current.length)return;let e=ey.current,t=eg.current.pop();eb.current.push(e),r(t),e_()},[e_]),eS=(0,n.useCallback)(()=>{if(0===eb.current.length)return;let e=ey.current,t=eb.current.pop();eg.current.push(e),r(t),e_()},[e_]),eC=(0,n.useCallback)(()=>{let e=`room-${Date.now()}`,t=ey.current.filter(e=>"room"===e.kind),n=(0,A.findNonOverlappingRoomPosition)(t,8e3,8e3,Z.target,Z.position),r=ey.current.filter(e=>"room"===e.kind).length,o={id:e,kind:"room",name:`방 ${r+1}`,width:8e3,depth:8e3,height:3e3,position:n,rotation:[0,0,0],color:"#a8afb3"};ek([...ey.current,o]),ew(e)},[ek,ew,Z]),eE=(0,n.useCallback)(()=>{let e=`room-${Date.now()}`,t=ey.current.filter(e=>"room"===e.kind),n=(0,A.findNonOverlappingRoomPosition)(t,2400,8e3,Z.target,Z.position),r=ey.current.filter(e=>"room"===e.kind&&!1===e.hasWalls).length,o={id:e,kind:"room",name:`공간 ${r+1}`,width:2400,depth:8e3,height:3e3,position:n,rotation:[0,0,0],color:"#a8afb3",hasWalls:!1};ek([...ey.current,o]),ew(e)},[ek,ew,Z]),eO=(0,n.useCallback)(e=>{let t=`${e}-${Date.now()}`,n=ey.current.find(e=>e.id===a)??null,r=(()=>{if(n?.kind==="room")return n;if(eh.current){let e=ey.current.find(e=>"room"===e.kind&&e.id===eh.current);if(e)return e}return ey.current.find(e=>"room"===e.kind)})(),o=R.FURNITURE_DEFAULT_DIMENSIONS[e],i=ey.current.filter(e=>"furniture"===e.kind).length,l={id:t,kind:"furniture",furnitureType:e,roomId:r?.id??null,name:`${R.TYPE_LABELS[e]} ${i+1}`,width:o.width,depth:o.depth,height:o.height,position:[0,10*("door"!==e),0],rotation:[0,0,0],color:F[e]};ek([...ey.current,l]),ew(t)},[ek,a,ew]),eT=(0,n.useCallback)(e=>{let t=`${e}-${Date.now()}`,n=ey.current.find(e=>e.id===a)??null,r=(()=>{if(n?.kind==="room")return n;if(eh.current){let e=ey.current.find(e=>"room"===e.kind&&e.id===eh.current);if(e)return e}return ey.current.find(e=>"room"===e.kind)})(),o=R.MODEL_DEFAULT_DIMENSIONS[e],i=ey.current.filter(e=>"model"===e.kind).length,l={id:t,kind:"model",modelType:e,roomId:r?.id??null,name:`${R.MODEL_LABELS[e]} ${i+1}`,width:o.width,depth:o.depth,height:o.height,position:[0,10,0],rotation:[0,0,0],color:z[e]};ek([...ey.current,l]),ew(t)},[ek,a,ew]),eI=(0,n.useCallback)((e,t)=>{ek(ey.current.map(n=>n.id===e?{...n,...t}:n))},[ek]),eN=(0,n.useCallback)(()=>{if(!a)return;let e=ey.current.find(e=>e.id===a);e?.kind==="room"?ek(ey.current.filter(e=>("furniture"!==e.kind&&"model"!==e.kind||e.roomId!==a)&&e.id!==a)):ek(ey.current.filter(e=>e.id!==a)),ew(null)},[ek,a,ew]),eD=(0,n.useCallback)(e=>e.map(e=>{if("model"===e.kind){let t=R.MODEL_DEFAULT_DIMENSIONS[e.modelType];return t&&("number"!=typeof e.width||"number"!=typeof e.depth||"number"!=typeof e.height)?Array.isArray(e.scale)&&3===e.scale.length?{...e,width:t.width*e.scale[0],depth:t.depth*e.scale[2],height:t.height*e.scale[1]}:{...e,width:t.width,depth:t.depth,height:t.height}:e}if("furniture"!==e.kind)return e;let t=R.FURNITURE_DEFAULT_DIMENSIONS[e.furnitureType];return t&&("number"!=typeof e.width||"number"!=typeof e.depth||"number"!=typeof e.height)?Array.isArray(e.scale)&&3===e.scale.length?{...e,width:t.width*e.scale[0],depth:t.depth*e.scale[2],height:t.height*e.scale[1]}:{...e,width:t.width,depth:t.depth,height:t.height}:e}),[]),eL=(0,n.useCallback)(e=>{let t=e.filter(e=>"room"===e.kind),n=e.filter(e=>"room"!==e.kind);return t.length<=1&&0===n.length},[]),e$=(0,n.useCallback)(()=>{let t=new Blob([JSON.stringify({items:e,camera:Z,wallOpacity:J,autoTransparent:Q,version:1},null,2)],{type:"application/json"}),n=URL.createObjectURL(t),r=document.createElement("a");r.href=n,r.download=`drop-the-furniture-${Date.now()}.json`,r.click(),URL.revokeObjectURL(n)},[e,Z,J,Q]),eP=(0,n.useCallback)(e=>{let t=e.target.files?.[0];if(!t)return;let n=new FileReader;n.onload=e=>{try{let t=JSON.parse(e.target?.result);if(!Array.isArray(t.items)||!t.camera)return void window.alert("올바르지 않은 파일 형식입니다.");let n=eD(t.items);ek(n),K(t.camera),q(t.wallOpacity??1),ee(t.autoTransparent??!1),ew(null)}catch{window.alert("JSON 파싱에 실패했습니다.")}},n.readAsText(t),e.target.value=""},[ek,ew,eD]),eA=(0,n.useCallback)(()=>{(eg.current?.length>0||eb.current?.length>0)&&e$();let e={id:`room-${Date.now()}`,kind:"room",name:"방 1",width:8e3,depth:8e3,height:3e3,position:[0,0,0],rotation:[0,0,0],color:"#a8afb3"};eg.current=[],eb.current=[],r([e]),ew(null),K(B),q(.5),eh.current=e.id,localStorage.removeItem(W),e_()},[e_,e$,ew]);(0,n.useEffect)(()=>{let e=e=>{let t=e.items.find(e=>"room"===e.kind);eh.current=t?.id??G.id,(0,n.startTransition)(()=>{r(e.items),d(e.selectedId??null),V(e.mode??"translate"),K(e.camera??B),q(e.wallOpacity??1),ee(e.autoTransparent??!1)})},t=function(){try{let e=localStorage.getItem(W);if(e)return JSON.parse(e)}catch{}return null}();t&&Array.isArray(t.items)&&!eL(t.items)?e({items:eD(t.items),camera:t.camera,wallOpacity:t.wallOpacity,autoTransparent:t.autoTransparent,selectedId:t.selectedId,mode:t.mode}):fetch("/sample_layout.json").then(e=>e.json()).then(t=>{Array.isArray(t.items)&&e({items:eD(t.items),camera:t.camera,wallOpacity:t.wallOpacity,autoTransparent:t.autoTransparent})}).catch(()=>{})},[eL,eD]),(0,n.useEffect)(()=>{ey.current=e},[e]),(0,n.useEffect)(()=>{localStorage.setItem(W,JSON.stringify({items:e,selectedId:a,mode:Y,camera:Z,wallOpacity:J,autoTransparent:Q,version:1}))},[e,a,Y,Z,J,Q]),(0,n.useEffect)(()=>{let t=e.find(e=>e.id===a);t?.kind==="room"&&(eh.current=t.id)},[e,a]),(0,n.useEffect)(()=>{let e=e=>{if("Escape"===e.key){a&&(e.preventDefault(),ew(null));return}if("Delete"===e.key||"Backspace"===e.key){if(e.target instanceof HTMLInputElement||e.target instanceof HTMLTextAreaElement)return;if(a){e.preventDefault(),eN();return}}(e.ctrlKey||e.metaKey)&&("z"!==e.key.toLowerCase()||e.shiftKey?("y"===e.key.toLowerCase()||"z"===e.key.toLowerCase()&&e.shiftKey)&&(e.preventDefault(),eS()):(e.preventDefault(),ej()))};return window.addEventListener("keydown",e),()=>{window.removeEventListener("keydown",e)}},[ej,eS,a,eN,ew]),(0,n.useEffect)(()=>{if(!el)return;let e=e=>{ep.current&&!ep.current.contains(e.target)&&es(!1)};return window.addEventListener("pointerdown",e),()=>{window.removeEventListener("pointerdown",e)}},[el]),e.filter(e=>"room"===e.kind).length,e.filter(e=>"furniture"===e.kind).length;let eR=e.filter(e=>"room"===e.kind),eM=e.filter(e=>"furniture"===e.kind&&!e.roomId),eH=e.filter(e=>"model"===e.kind&&!e.roomId),eU=e.find(e=>e.id===a);return eU?.kind,(0,t.jsxs)(l,{children:[(0,t.jsxs)(o.default,{children:[(0,t.jsx)("title",{children:"Drop the Furniture - 3D 방 & 가구 배치"}),(0,t.jsx)("meta",{name:"description",content:"3D 공간에서 방과 가구를 자유롭게 배치하고 편집할 수 있는 Next.js 기반 웹 앱입니다. 방 추가, 가구 배치, 이동/회전/크기 조절, 저장/불러오기 기능을 제공합니다."}),(0,t.jsx)("meta",{name:"keywords",content:"3D 가구 배치, 방 꾸미기, 인테리어 시뮬레이터, Drop the Furniture, Three.js, Next.js, 가구 배치 도구"}),(0,t.jsx)("meta",{name:"author",content:"Drop the Furniture"}),(0,t.jsx)("meta",{name:"theme-color",content:"#ffffff"}),(0,t.jsx)("meta",{name:"robots",content:"index, follow"}),(0,t.jsx)("meta",{property:"og:type",content:"website"}),(0,t.jsx)("meta",{property:"og:title",content:"Drop the Furniture - 3D 방 & 가구 배치"}),(0,t.jsx)("meta",{property:"og:description",content:"3D 공간에서 방과 가구를 자유롭게 배치하고 편집할 수 있는 웹 앱입니다."}),(0,t.jsx)("meta",{name:"twitter:card",content:"summary"}),(0,t.jsx)("meta",{name:"twitter:title",content:"Drop the Furniture - 3D 방 & 가구 배치"}),(0,t.jsx)("meta",{name:"twitter:description",content:"3D 공간에서 방과 가구를 자유롭게 배치하고 편집할 수 있는 웹 앱입니다."})]}),(0,t.jsxs)(s,{children:[(0,t.jsx)(u,{onPointerDown:e=>{e.stopPropagation()},onClick:e=>{es(e=>!e)},children:"☰"}),(0,t.jsxs)("div",{children:[(0,t.jsx)("h1",{children:"Drop the Furniture"}),(0,t.jsx)("p",{children:"방과 가구를 자유롭게 배치해보세요."})]}),(0,t.jsx)(c,{onClick:()=>ec(e=>!e),children:"⋮"}),(0,t.jsxs)(L,{$open:eu,children:[(0,t.jsx)(b,{$compact:!0,onClick:eA,children:"🗑️ New"}),(0,t.jsx)(b,{$compact:!0,onClick:ej,disabled:!er,children:"↩ Undo"}),(0,t.jsx)(b,{$compact:!0,onClick:eS,disabled:!ei,children:"↪ Redo"}),(0,t.jsx)(b,{$compact:!0,onClick:e$,children:"💾 저장"}),(0,t.jsx)(b,{$compact:!0,onClick:()=>ex.current?.click(),children:"📂 불러오기"}),(0,t.jsx)("input",{ref:ex,type:"file",accept:"application/json",style:{display:"none"},onChange:eP})]})]}),(0,t.jsxs)(f,{ref:ep,$open:el,children:[(0,t.jsx)(h,{children:"방 추가"}),(0,t.jsxs)(g,{children:[(0,t.jsx)(b,{onClick:eC,children:"방"}),(0,t.jsx)(b,{onClick:eE,children:"공간"}),(0,t.jsx)(b,{onClick:()=>eO("door"),children:"🚪 문"})]}),(0,t.jsx)(p,{}),(0,t.jsx)(h,{children:"가구 추가"}),(0,t.jsx)(g,{children:H.map(e=>(0,t.jsx)(b,{onClick:()=>eO(e),children:R.TYPE_LABELS[e]},e))}),(0,t.jsx)(C,{children:"버튼을 누르면 방 중앙에 방/가구/문이 생성됩니다."}),(0,t.jsx)(p,{}),(0,t.jsx)(h,{children:"모델 추가"}),(0,t.jsx)(g,{children:U.map(e=>(0,t.jsx)(b,{onClick:()=>eT(e),children:R.MODEL_LABELS[e]},e))}),(0,t.jsx)(p,{}),(0,t.jsx)(h,{children:"설정"}),(0,t.jsx)(C,{children:"벽 투명도"}),(0,t.jsx)($,{type:"range",min:0,max:1,step:.05,value:J,onChange:e=>q(parseFloat(e.target.value))}),(0,t.jsx)(b,{$compact:!0,$active:Q,onClick:()=>ee(e=>!e),children:"👁 자동 투명"}),(0,t.jsx)(p,{}),(0,t.jsxs)(h,{children:["목록",eR.length>0&&(0,t.jsxs)(m,{children:[(0,t.jsx)(y,{title:"모두 펼치기",onClick:()=>ef(new Set),children:"⊞"}),(0,t.jsx)(y,{title:"모두 접기",onClick:()=>ef(new Set(eR.map(e=>e.id))),children:"⊟"})]})]}),(0,t.jsxs)(E,{children:[eR.map(r=>{let o=[...e.filter(e=>"furniture"===e.kind&&e.roomId===r.id),...e.filter(e=>"model"===e.kind&&e.roomId===r.id)];return(0,t.jsxs)(n.Fragment,{children:[(0,t.jsxs)(O,{$selected:r.id===a,$kind:"room",$dragOver:et===r.id,onClick:()=>ew(r.id),onDragOver:e=>{e.preventDefault(),em.current&&en(r.id)},onDragLeave:()=>en(null),onDrop:()=>{let e=em.current;e&&(eI(e,{roomId:r.id,position:[0,10,0]}),em.current=null,en(null))},children:[(0,t.jsxs)(D,{children:[(0,t.jsx)(N,{onPointerDown:e=>e.stopPropagation(),onClick:e=>{e.stopPropagation(),ev(r.id)},children:ed.has(r.id)?"▸":"▾"}),r.name]}),(0,t.jsx)(I,{children:!1===r.hasWalls?"공간":"방"})]}),!ed.has(r.id)&&(0,t.jsx)(T,{$dragOver:et===r.id,$empty:0===o.length,onDragOver:e=>{e.preventDefault(),em.current&&en(r.id)},onDragLeave:()=>en(null),onDrop:()=>{let e=em.current;e&&(eI(e,{roomId:r.id,position:[0,10,0]}),em.current=null,en(null))},children:o.length>0?o.map(e=>{let n="model"===e.kind?R.MODEL_LABELS[e.modelType]:R.TYPE_LABELS[e.furnitureType];return(0,t.jsxs)(O,{$selected:e.id===a,$kind:"furniture",$tree:!0,draggable:!0,onClick:()=>ew(e.id),onDragStart:()=>{em.current=e.id},onDragEnd:()=>{em.current=null,en(null)},children:[(0,t.jsx)("span",{children:e.name}),(0,t.jsx)(I,{children:n})]},e.id)}):(0,t.jsx)(C,{children:"여기로 드래그"})})]},r.id)}),eM.map(e=>(0,t.jsxs)(O,{$selected:e.id===a,$kind:"furniture",draggable:!0,onClick:()=>ew(e.id),onDragStart:()=>{em.current=e.id},onDragEnd:()=>{em.current=null,en(null)},children:[(0,t.jsx)("span",{children:e.name}),(0,t.jsx)(I,{children:R.TYPE_LABELS[e.furnitureType]})]},e.id)),eH.map(e=>(0,t.jsxs)(O,{$selected:e.id===a,$kind:"furniture",draggable:!0,onClick:()=>ew(e.id),onDragStart:()=>{em.current=e.id},onDragEnd:()=>{em.current=null,en(null)},children:[(0,t.jsx)("span",{children:e.name}),(0,t.jsx)(I,{children:R.MODEL_LABELS[e.modelType]})]},e.id))]}),!eU&&(0,t.jsx)(C,{children:"목록에서 항목을 클릭하면 선택해서 편집할 수 있습니다."})]}),eU&&(0,t.jsxs)(P,{children:[(0,t.jsx)(g,{$nowrap:!0,children:["translate","rotate","scale"].map(e=>(0,t.jsx)(b,{$active:Y===e,onClick:()=>V(e),children:R.MODE_LABELS[e]},e))}),(0,t.jsx)(v,{type:"text",value:eU.name,style:{width:"130px"},onChange:e=>eI(eU.id,{name:e.target.value})}),(0,t.jsx)(x,{children:(0,t.jsx)(_,{type:"color",value:eU.color,style:{width:"36px",padding:0},onChange:e=>eI(eU.id,{color:e.target.value})})}),"model"===eU.kind&&R.MODEL_ANIMATIONS[eU.modelType]&&(0,t.jsx)(i.default,{styles:X,value:eU.animationName&&R.MODEL_ANIMATIONS[eU.modelType].includes(eU.animationName)?{value:eU.animationName,label:R.ANIMATION_LABELS[eU.animationName]??eU.animationName}:null,onChange:e=>eI(eU.id,{animationName:e?.value||void 0}),options:R.MODEL_ANIMATIONS[eU.modelType].map(e=>({value:e,label:R.ANIMATION_LABELS[e]??e})),placeholder:"애니메이션"}),("room"===eU.kind||"furniture"===eU.kind||"model"===eU.kind)&&(0,t.jsx)(k,{style:{gap:"6px"},children:["width","depth","height"].map((e,n)=>(0,t.jsxs)(j,{style:{width:"72px"},children:[(0,t.jsx)(w,{type:"number",min:100,step:"room"===eU.kind?100:10,value:eU[e],onChange:t=>eI(eU.id,{[e]:parseFloat(t.target.value)||1})}),(0,t.jsx)(S,{children:["W","D","H"][n]})]},e))}),(0,t.jsx)(b,{$danger:!0,$compact:!0,onClick:eN,children:"삭제"})]}),(0,t.jsx)(M,{items:e,selectedId:a,mode:Y,cameraState:Z,wallOpacity:J,autoTransparent:Q,onSelect:ew,onChange:eI,onCameraChange:K})]})}],83594)},9977,(e,t,n)=>{(window.__NEXT_P=window.__NEXT_P||[]).push(["/c",()=>e.r(83594)]),t.hot&&t.hot.dispose(function(){window.__NEXT_P.push(["/c"])})},48761,e=>{e.v(t=>Promise.all(["static/chunks/0ey~yy8oeyp~5.js"].map(t=>e.l(t))).then(()=>t(93594)))},28805,e=>{e.v(t=>Promise.all(["static/chunks/0599p99vu8fk5.js"].map(t=>e.l(t))).then(()=>t(79466)))},17050,e=>{e.v(t=>Promise.all(["static/chunks/12rsiyd.996td.js"].map(t=>e.l(t))).then(()=>t(97220)))}]);